...
The slice view shows a list of a given type of element. Each item shows the path, data and attributes 
for that element. Slice view is opened by right clicking an element and selecting \verb+Slice+ or 
