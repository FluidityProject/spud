...
value of \verb+@prefix@+ is \verb+/usr+. If the file is not installed
in \verb+/usr/share/spud+ or \verb+/usr/local/share/spud+, the directory
containing the file \verb+spud_base.rnc+ must be specified in the
environment variable \verb+SPUD_SCHEMA_PATH+.
