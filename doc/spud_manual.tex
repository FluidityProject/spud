...
Libspud is built using a standard autoconf system. It should be possible to
...
\subsection{Root element suppression}
...
Reads the XML file \lstinline+filename+ into the options tree. The options tree
is cleared prior to loading the options file.
