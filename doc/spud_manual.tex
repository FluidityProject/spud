...
Spud is managed using Subversion. Version 1.0.7 can be obtained with the
command:

\begin{verbatim}
svn co http://amcg.ese.ic.ac.uk/svn/spud/branches/1.0.7 spud
\end{verbatim}
