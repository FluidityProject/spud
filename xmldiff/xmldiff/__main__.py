...
#    This file is part of xmldiff.
#
#    xmldiff is free software: you can redistribute it and/or modify
#    it under the terms of the GNU General Public License as published by
#    the Free Software Foundation, either version 3 of the License, or
#    (at your option) any later version.
#
#    xmldiff is distributed in the hope that it will be useful,
...
def __display_help():
  ...
  print "\n".join(["Usage: xmldiff [OPTIONS] ... [FILE1] [FILE2]",
                   "", 
